...
var _window = __webpack_require__(26);
...
var Drawer = function (_PureComponent) {
  ...
  function Drawer(props) {
    ...
    _this.getNetgativeScroll = function (element) {
      _this.NEGATIVE_SCROLL = _window2.default.innerHeight - element.scrollHeight - 20;
    };
    ...
    _this.attachListeners = function () {
      _this.parentElement.addEventListener('touchmove', _this.preventDefault);
      _this.parentElement.addEventListener('scroll', _this.preventDefault);
      _this.parentElement.addEventListener('mousewheel', _this.preventDefault);

      if (!_this.drawer) return;
      _this.drawer.addEventListener('touchend', _this.onTouchEnd);
      _this.drawer.addEventListener('touchmove', _this.onTouchMove);
      _this.drawer.addEventListener('touchstart', _this.onTouchStart);
    };

    _this.removeListeners = function () {
      _this.parentElement.removeEventListener('touchmove', _this.preventDefault);
      _this.parentElement.removeEventListener('scroll', _this.preventDefault);
      _this.parentElement.removeEventListener('mousewheel', _this.preventDefault);

      if (!_this.drawer) return;
      _this.drawer.removeEventListener('touchend', _this.onTouchEnd);
      _this.drawer.removeEventListener('touchmove', _this.onTouchMove);
      _this.drawer.removeEventListener('touchstart', _this.onTouchStart);
    };
    ...
    _this.onTouchMove = function (event) {
      var movingPosition = event.touches[0].pageY;
      var delta = movingPosition - _this.state.thumbY;

      if (_this.props.onDrag) {
        _this.props.onDrag();
      }

      if (!(delta + _this.state.position < _this.NEGATIVE_SCROLL)) {
        _this.updatePosition(delta);
        _this.updateThumbY(movingPosition);
      }
    };
    ...
    _this.onTouchEnd = function (event) {
      ...
      if (_this.state.position >= 0 && _this.state.thumbY - _this.state.startThumbY > _this.SCROLL_TO_CLOSE) {
        _this.hideDrawer();
      }
    };
    ...
    _this.updateThumbY = function (thumbPosition) {
      _this.setState(function () {
        return {
    ...
    _this.updatePosition = function (delta) {
      _this.setState(function () {
        return {
          position: _this.state.position + delta
        };
      });
    };
    ...
    _this.BACKGROUND_OPACITY = props.overlayOpacity || 0.6;
    _this.SCROLL_TO_CLOSE = props.scrollToClose || 50;
    _this.parentElement = props.parentElement || _document2.default.body;

    // do we have any styles to apply to the container?
    _this.containerStyle = props.containerStyle || {};

    // typeof check, because false will otherwise be ignored
    _this.allowClose = props.allowClose || typeof props.allowClose !== 'boolean';
    return _this;
  }
  ...
  _createClass(Drawer, [{
    ...
    value: function render() {
      ...
      if (!this.props.open && !this.state.open) return _react2.default.createElement('div', null);
      ...
      return _react2.default.createElement(
        ...
        {
          style: {
            translateY: (0, _reactMotion.spring)(open ? position : _window2.default.innerHeight, animationSpring),
            opacity: (0, _reactMotion.spring)(open ? this.BACKGROUND_OPACITY : 0)
          },
          defaultStyle: {
            opacity: 0,
            translateY: _window2.default.innerHeight
          }
        },
        function (_ref) {
          ...
          return _react2.default.createElement(
            'div',
            {
              style: _extends({ backgroundColor: 'rgba(55, 56, 56, ' + opacity + ')' }, _this3.containerStyle),
            ...
            _react2.default.createElement(_style2.default, {
              styleId: 3218744792,
              css: '.drawerContainer[data-jsx="3218744792"] {position: fixed;top: 0;left: 0;right: 0;bottom: 0;display:-webkit-flex; display:flex;justify-content: center;z-index: 11;align-items: center;}@media(max-width: 768px) {.drawerContainer[data-jsx="3218744792"] {height: 100%;width: 100%;}}'
            })
          );
        }
      );
...
Drawer.propTypes = {
  ...
  children: _propTypes2.default.oneOfType([_react2.default.PropTypes.object, _react2.default.PropTypes.array]).isRequired,
  onRequestClose: _propTypes2.default.func.isRequired,
  onDrag: _propTypes2.default.func,
  onOpen: _propTypes2.default.func,
  negativeScroll: _propTypes2.default.number,
  overlayOpacity: _propTypes2.default.number,
  scrollToClose: _propTypes2.default.number,
